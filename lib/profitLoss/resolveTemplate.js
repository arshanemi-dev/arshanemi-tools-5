...
// ── helpers ───────────────────────────────────────────────────────────────
// Exported so DashboardWorkspace can read a raw canonical row's mapped Order
// Id / Transaction Id (the two reserved global headers) for upload dedup,
// the same way this file reads any other mapped header.
...
// single value when the group agrees, else every distinct value it saw.
